#!/usr/bin/env python3
"""
Smart Shopper US - Mega Agent v3
100+ products, CDN images, posts every 5 mins
"""
...
PRODUCTS = [
    ...
    {"name": "TP-Link WiFi 6 Router", "asin": "B08H8YLKH2", "img": "https://m.media-amazon.com/images/I/71Ae5465YRL._AC_SL500_.jpg", "price": "$89.99", "original": "$129.99", "discount": "31%", "emoji": "📶", "cat": "Electronics"},
    ...
    {"name": "TheraGun Mini Massager", "asin": "B084Z34N6R", "img": "https://m.media-amazon.com/images/I/51IxTFdOkfL._AC_SL500_.jpg", "price": "$149.00", "original": "$199.00", "discount": "25%", "emoji": "💆", "cat": "Health"},
    ...
    {"name": "Jump Rope Speed Cable", "asin": "B01KTN5RJO", "img": "https://m.media-amazon.com/images/I/71R9p0GvE5L._AC_SL500_.jpg", "price": "$14.97", "original": "$24.99", "discount": "40%", "emoji": "⚡", "cat": "Sports"},
    ...
    {"name": "Hot Wheels 20 Car Gift Pack", "asin": "B07GDPCNSC", "img": "https://m.media-amazon.com/images/I/81SnBObFgML._AC_SL500_.jpg", "price": "$19.97", "original": "$34.99", "discount": "43%", "emoji": "🚗", "cat": "Toys"},
    ...
    {"name": "Xbox Series X Controller", "asin": "B08DF248LD", "img": "https://m.media-amazon.com/images/I/61SUj2aKoEL._AC_SL500_.jpg", "price": "$49.99", "original": "$64.99", "discount": "23%", "emoji": "🎮", "cat": "Gaming"},
    ...
    {"name": "Rich Dad Poor Dad", "asin": "1612680194", "img": "https://m.media-amazon.com/images/I/81bsw6fnUiL._AC_SL500_.jpg", "price": "$9.99", "original": "$17.95", "discount": "44%", "emoji": "📖", "cat": "Books"},
    ...
    {"name": "Black Diamond Headlamp", "asin": "B07MHZGKZV", "img": "https://m.media-amazon.com/images/I/61S9M3MCURL._AC_SL500_.jpg", "price": "$39.95", "original": "$59.95", "discount": "33%", "emoji": "🔦", "cat": "Outdoor"},
    ...
    {"name": "Furminator Deshedding Tool", "asin": "B000RZD8EE", "img": "https://m.media-amazon.com/images/I/71Q3GU4KuXL._AC_SL500_.jpg", "price": "$31.99", "original": "$44.99", "discount": "29%", "emoji": "🐱", "cat": "Pets"},
    ...
    {"name": "HP LaserJet Printer", "asin": "B01N3CNHZW", "img": "https://m.media-amazon.com/images/I/71Oc3bKF+yL._AC_SL500_.jpg", "price": "$109.00", "original": "$169.00", "discount": "36%", "emoji": "🖨️", "cat": "Office"},
    ...
    {"name": "Car Phone Mount", "asin": "B07MGVPKQ3", "img": "https://m.media-amazon.com/images/I/71y3fCL+jDL._AC_SL500_.jpg", "price": "$15.99", "original": "$25.99", "discount": "38%", "emoji": "📱", "cat": "Auto"},
    ...
    {"name": "Levi Straight Jeans 501", "asin": "B07HHD7LJT", "img": "https://m.media-amazon.com/images/I/81PJGb5JPTL._AC_SL500_.jpg", "price": "$39.99", "original": "$69.50", "discount": "43%", "emoji": "👖", "cat": "Fashion"},
    {"name": "Herschel Supply Backpack", "asin": "B07BKFQ1NJ", "img": "https://m.media-amazon.com/images/I/71VtqGFf7RL._AC_SL500_.jpg", "price": "$44.99", "original": "$69.99", "discount": "36%", "emoji": "🎒", "cat": "Fashion"},
    ...
    {"name": "Moleskine Classic Notebook", "asin": "B07FN3KQQG", "img": "https://m.media-amazon.com/images/I/61z5e9m5onL._AC_SL500_.jpg", "price": "$16.48", "original": "$24.95", "discount": "34%", "emoji": "📓", "cat": "Office"},
    ...
    {"name": "Tire Inflator Portable", "asin": "B07VPHCSVD", "img": "https://m.media-amazon.com/images/I/71jN5msJx3L._AC_SL500_.jpg", "price": "$35.99", "original": "$54.99", "discount": "35%", "emoji": "🚙", "cat": "Auto"},
...
def send_telegram_photo(image_url, caption):
    ...
    try:
        r = requests.post(url, json={"chat_id": TELEGRAM_CHANNEL, "photo": image_url, "caption": caption, "parse_mode": "Markdown"}, timeout=15)
        result = r.json()
        if result.get("ok"):
            print("✅ Photo posted!")
            return True
...
def run_agent():
    print("🤖 Smart Shopper Mega Agent v3")
    print(f"📢 {TELEGRAM_CHANNEL} | 📦 {len(PRODUCTS)} products | ⏱ Every 5 mins")
    print("=" * 50)
